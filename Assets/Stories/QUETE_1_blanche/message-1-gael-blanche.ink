...
=== Reponse_2 ===
- MSG;B;4.5;Vous faites erreur, je voulais pas du tout vous faire peur, désolé, je suis votre voisin du dessus. Vous n'aviez pas l'air bien quand je vous ai croisée tout à l'heure dans les escaliers et je voulais m'assurer que vous alliez bien
* [Tout va bien merci] MSG;A;2.5;Tout va bien, vous n'aviez pas besoin de vous inquiéter, bonne journée.
-> vraiment
* [Ça ne va pas bien] MSG;A;4.5;J'ai reçu des messages assez durs ce matin, et ce n'est pas la première fois. Je ne sais pas quoi faire...
-> confession_1
...
-> confession_1
 ...
 === vraimentvrai_sur ===
- MSG;B;3.5;Vous savez on m'a éduqué en me disant qu'il fallait écouter les anciens. Si vous avez besoin de quelqu'un, je suis là
* [Ça ne va pas bien] MSG;A;3.0;J'ai reçu des messages assez durs ce matin, et ce n'est pas la première fois. Je ne sais pas quoi faire...
-> confession_1
...
=== confession_2bis ===
- MSG;B;4.0;Ça doit être le petit Sacha qui a fait le coup. J'en parlerai à ses parents si vous voulez
...
MSG;A;6.0;Je ne veux pas que les gens sachent pour mon asperger. Au moment où je militais cela avait du sens, mais maintenant je ne suis plus qu'une vieille veuve qui ne sort pas trop de chez elle.
->confession_6
* [Ne pas répondre]
->dernier_sms
...
MSG;A;5.5;Merci d'avoir pris le temps de parler avec moi. Tout ça m'a grandement fatiguée, je vais me reposer. N'hésitez pas à passer prendre un thé chez moi, vous aurez sûrement envie de voir Nestor, Ricky, Carotte et Patachon
 ->bonne_fin

=== dernier_sms ===
- MSG;B;5.5;Courage ! Je sais à quel point c'est compliqué de trouver sa place :)
->END

=== bonne_fin ===
- MSG;B;5.5;Avec plaisir, à bientôt
->END