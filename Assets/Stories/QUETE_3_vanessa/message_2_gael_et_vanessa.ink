...
- MSG;B;3.0; C'est sûr...
* [Désolée] MSG;A;5.0;Désolée, je ne voulais pas parler de chose aussi grave, c'est évident qu'avec tes pouvoirs de magical girl personne ne t'approche <3
MSG;B;2.5;Pas de soucis, on reparlera ça une autre fois si tu veux, là je dois filer, à plus tard ;)
->END
...
* [Difficulté] MSG;A;5.0;Après c'est pas tous rose, ma recherche de stage ne se passe pas comme je l'espérais, dans l'ensemble mon CV plait mais on me rappelle jamais après les entretients.
-> amerde
* [Ne pas répondre]
-> autrefinal2
